...
const COMMENT_TYPES = [
  ...
  { value: 'criticism', label: '⚠️ Criticism' },
  ...
  return (
    <ToolLayout>
      <ToolTitle 
        ...
        description="Generate engaging responses to your YouTube comments"
      />
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <p className="text-sm text-muted-foreground">
                    Describe the type of comments you want to respond to and how you'd like to respond. Include any specific requirements or style preferences.
                  </p>
                  <Textarea
                    placeholder="E.g., 'I want to respond to comments asking for video recommendations with friendly, detailed suggestions that include timestamps from my previous videos.'"
                    value={customPrompt}
