...
export function InstagramIdeaGeneratorPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const ideas = [
        "Behind-the-scenes look at your daily routine",
        "Quick tips and tricks in your niche",
        "Before and after transformation",
        "Day in the life series",
        "Product showcase with creative transitions",
        "Tutorial with a unique twist",
        "Collaboration with another creator",
        "Trending sound recreation",
  ...
  return (
    <ToolPageWrapper
      ...
      description="Generate engaging Instagram content ideas that resonate with your audience"
    >
      <div className="space-y-6">
        {currentStep === 'input' && (
          <Card>
            <CardHeader>
              <CardTitle>Generate Instagram Content Ideas</CardTitle>
              <CardDescription>
                Enter your niche or topic to get personalized content ideas
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Textarea
                  placeholder="Enter your niche or topic (e.g., fitness, cooking, tech reviews)..."
                  value={niche}
