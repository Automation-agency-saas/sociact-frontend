...
const COMMENT_TYPES = [
  { value: 'post-comment', label: '💬 Post Comments' },
  { value: 'article-comment', label: '📝 Article Comments' },
...
const RESPONSE_LENGTHS = [
  { value: 'short', label: '⚡ Brief (1-2 sentences)' },
  { value: 'medium', label: '📝 Standard (2-4 sentences)' },
  { value: 'long', label: '📄 Detailed (4+ sentences)' }
];
...
export function LinkedInCommentAutomationPage() {
  // Form states
  ...
  const loadingMessages = [
    ...
    "Crafting industry-specific responses...",
        ...
        responses: [
          {
            ...
            response_tone: responseTone,
            response_length: responseLength,
            sample_comment: "Your insights on digital transformation are spot-on. Would love to hear more about how AI is reshaping the industry landscape.",
            generated_response: "Thank you for your thoughtful comment! You raise an excellent point about AI's impact. Based on my experience in the field, we're seeing unprecedented integration of AI across various sectors. I'd be happy to share some recent case studies that demonstrate this transformation. Let's connect and discuss further!",
            engagement_tips: "Reference specific industry examples and invite professional connections"
          }
        ]
      };
        ...
        responses: [
          {
            ...
            generated_response: "Your perspective on industry trends is invaluable. I've observed similar patterns in my work with enterprise clients. Would you be interested in collaborating on a thought leadership piece about this topic? Let's connect and explore the possibilities.",
            engagement_tips: "Suggest collaboration opportunities and professional networking"
          }
        ]
      };
  ...
  return (
    <ToolLayout>
      <ToolTitle 
        ...
        description="Generate professional responses to comments, articles, and endorsements"
      />
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <p className="text-sm text-muted-foreground">
                    Describe the type of LinkedIn interactions you want to respond to and how you'd like to respond. Include any specific industry context or professional requirements.
                  </p>
                  <Textarea
                    placeholder="E.g., 'I want to respond to comments on my thought leadership articles about digital transformation with insightful, data-driven responses that establish expertise and encourage professional networking.'"
                    value={customPrompt}
