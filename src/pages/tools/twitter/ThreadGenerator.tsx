...
export function TwitterThreadGeneratorPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await contentGeneratorService.generateTwitterThread(
        description,
        Number(tweetCount)
      );
      ...
      const errorMessage =
        err instanceof Error ? err.message : "Failed to generate thread";
          ...
          >
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                <Button variant="outline" size="sm" onClick={copyEntireThread}>
