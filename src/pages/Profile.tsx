...
import { CheckCircle2, PencilIcon, Pencil, ChevronLeft, ChevronRight, Upload, Camera, Loader2, Instagram, Twitter, Youtube, Linkedin, Link as LinkIcon, Plus, Globe, Sparkles, Users, UserPlus, MessageSquare, Heart, User, Link2, FileText, Image, Search } from 'lucide-react';
            ...
            >
                ...
                <div className="flex flex-col md:flex-row items-center gap-6">
                  ...
                  >
                    <div className="w-32 h-32 rounded-full border-4 border-background shadow-xl overflow-hidden">
                      <img
                        src={isEditing ? editedUser.picture : (user?.picture || `https://ui-avatars.com/api/?name=${user?.name}`)}
                        alt={user?.name}
                            ...
                            <div className="grid gap-6 py-4">
                              <div className="flex flex-col items-center gap-4">
                                <div className="w-40 h-40 rounded-full border-4 border-muted overflow-hidden">
                                  <img
                                    src={editedUser.picture || `https://ui-avatars.com/api/?name=${editedUser.name}`}
                                    alt={editedUser.name}
                                    className="w-full h-full object-cover"
                                  />
                                </div>
              ...
              <Button
                              ...
                              <div className="grid grid-cols-4 gap-4">
                                {['adventurer', 'avataaars', 'big-ears', 'bottts', 'pixel-art', 'fun-emoji', 'thumbs', 'initials'].map((style) => (
                                  <Button
                                    key={style}
                                    variant="outline"
                  ...
                  <motion.div layout className="grid gap-4">
                    ...
                    {Object.entries({
                      ...
                      >
                        <HoverCard>
                          <HoverCardTrigger>
                            <div className={`flex items-center gap-4 p-4 rounded-lg border bg-card/50 backdrop-blur-sm transition-colors hover:bg-accent/5`}>
                          ...
                          <HoverCardContent>
                            <div className="flex justify-between space-x-4">
                              <div className="space-y-1">
                                <h4 className="text-sm font-semibold">{platform.charAt(0).toUpperCase() + platform.slice(1)}</h4>
                                <p className="text-sm text-muted-foreground">
                                  Connect your {platform} profile to share your content
                                </p>
                              </div>
                            </div>
                          </HoverCardContent>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-4">
                            <div className={`p-2 rounded-md ${config.bgColor || 'bg-accent/10'}`}>
