    ...
    <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
      {tools.map((tool, index) => (
        <MagicCard
          key={index}
          className={cn(
            "cursor-pointer shadow-2xl group relative overflow-hidden bg-primary/50  border-white/50 flex flex-col",
        ...
        >
          ...
          <div className="flex-1 flex gap-5 p-4 md:p-6">
            <div className="rounded-lg group-hover:rounded-3xl w-40 h-full flex bg-zinc-100 p-2 md:p-3 flex-shrink-0 transition-all duration-500 ease-in-out">
              <tool.icon className="size-full p-3 group-hover:p-6 text-primary/70 transition-all duration-300 ease-in-out " />
            </div>
